...
class WeightResourceFeatureTest extends FeatureTest {
  override val server = new EmbeddedHttpServer(twitterServer = new FitmanServer)
    ...
    "List all weights for a user when GET request is made" in {
      val response = server.httpPost(
        ...
        postBody =
          ...
          |"user":"test_user_1",
          |"weight":175,
          |"posted_at" : "2016-01-03T14:45:06.871Z"
          |}
          """.stripMargin,
        andExpect = Status.Created
      )
      ...
      server.httpPost(
        ...
        postBody =
          ...
          withErrors = Seq(
            ...
            "weight: [500] is not between 50 and 450"
          )
      )
    }
