...
object MediumClient {
  ...
  def apply(clientId: String, clientSecret: String, accessToken: String): MediumClient =
    new MediumClient(clientId, clientSecret, Some(accessToken))
}
